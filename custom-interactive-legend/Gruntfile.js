module.exports = function (grunt) {
  ...
  grunt.initConfig({
    sass: {
      ...
      dist: {
        files: {
          ...
          'dist/Components/Share/css/Share.css': 'src/app/Components/Share/css/Share.scss',
          ...
          'dist/Components/Share/Share/css/Share.css': 'src/app/Components/Share/Share/css/Share.scss',
    ...
    postcss: {
      ...
      dist: {
        src: ["dist/styles/Main.css", 'dist/Components/InteractiveLegend/css/InteractiveLegend.css', 'dist/Components/Share/Share/css/Share.css', 'dist/Components/Screenshot/css/Screenshot.css', 'dist/Components/Header/css/Header.css', "!node_modules/**"]
      }
    },
    watch: {
      styles: {
        files: ['src/styles/Main.scss', 'src/app/Components/InteractiveLegend/css/InteractiveLegend.scss', 'src/app/Components/Screenshot/css/Screenshot.scss','src/app/Components/Share/Share/css/Share.scss',  'src/app/Components/Header/css/Header.scss', 'src/app/Components/Info/css/Info.scss'],
        tasks: ['styles']
      }
    },
    tslint: {
